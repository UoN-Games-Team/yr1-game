package com.djammr.westernknights.entity.ai.behaviours;
...
import com.djammr.westernknights.entity.ai.controllers.ProximityCallback;
...
public class SquareProximity implements Proximity<Vector2>, QueryCallback {
    ...
    protected com.djammr.westernknights.entity.ai.controllers.ProximityCallback behaviourCallback = null;
    ...
    public int findNeighborBodies(com.djammr.westernknights.entity.ai.controllers.ProximityCallback behaviourCallback) {
        neighbourCount = 0;
        this.behaviourCallback = behaviourCallback;
        prepareAABB(aabb);
        world.QueryAABB(this, aabb.lowerX, aabb.lowerY, aabb.upperX, aabb.upperY);
    ...
    protected SteeringEntity getSteerable(Fixture fixture) {
        if (fixture.getBody().getUserData() != null) {
            WKGame.logger.logDebug(String.valueOf(((Box2DUserData)fixture.getBody().getUserData()).steeringEntity));
